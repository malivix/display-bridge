...
| Review UI findings and feature delivery order | [Current review and implementation plan](plans/ui-feature-priority-review-2026-09-21.md) |
| Inspect current UI evidence | [Current eight-step UI review](ui-feature-review-current.md) |
| Compare display utilities and source evidence | [Current app comparison](research/display-app-review-refresh.md) |
...
checked at that revision. Current behavior belongs in the guides above, not historical logs.
